...
const DEFAULT_GALLERY_IMAGES = [
  {
    ...
    label: "Espaço Ellite Coworking - Área de Trabalho"
  },
  {
    src: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop",
    label: "Sala de Reunião Premium"
  },
  {
    src: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=600&fit=crop",
    label: "Estações de Trabalho Modernas"
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=600&fit=crop",
    label: "Café Gourmet Incluso"
  },
  {
    src: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop",
    label: "Localização Premium em Moema"
  }
];
...
const Gallery = () => {
  ...
  const { data: files, isLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        if (error) {
          console.warn("Erro ao carregar galeria do Supabase:", error);
          return [];
        }
  ...
  const galleryImages = useMemo(() => {
    // Se houver imagens do Supabase, usar elas
    ...
    // Caso contrário, usar imagens padrão
