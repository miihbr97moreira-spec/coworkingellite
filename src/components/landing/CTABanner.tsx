      ...
      <div className="container px-4 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-2xl md:text-4xl font-bold mb-4">
            <span className="text-gradient-gold">Sua próxima conquista</span>
            <br />
            <span className="text-foreground">começa no Ellite</span>
          </h2>
          <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
            Profissionais de alto nível escolhem ambientes de alto nível. Agende uma visita gratuita e descubra o que um espaço premium pode fazer pelo seu negócio.
          </p>
          <motion.button
            onClick={scrollToPlans}
            whileHover={{ scale: 1.05, boxShadow: "0 0 40px hsl(45 100% 56% / 0.5)" }}
            whileTap={{ scale: 0.97 }}
